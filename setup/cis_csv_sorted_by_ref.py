...
#
# Example: Ungrouped (One component per row) CSV output for CIS Control
#
...
"""
    ...
    Sorted By: Ref
    Fields: Ref, Value, Part, Symbol, Footprint, ItemNo

    Command line:
    python "pathToFile/cis_csv_sorted_by_ref.py" "%I" "%O.csv"
"""
...
for c in components:
    writerow( out, [c.getRef(), c.getValue(), c.getPartName(), c.getFootprint(), c.getField("ItemNo")])
